...
select B.* from [THLWToolBoxContext-088877b4-245d-43ef-b004-d1d23cc730e7].[dbo].[PlayerUnitData] as A inner join [THLWToolBoxContext-088877b4-245d-43ef-b004-d1d23cc730e7].[dbo].[SpellcardTableRaw] as B on A.shot1_id = B.id or A.shot2_id = B.id
